export function User() {
  return (
    ...
    >
      ...
      />
      <path
        d="M1.5 18.5063C2.2612 17.4231 3.27191 16.539 4.44676 15.9287C5.6216 15.3184 6.92608 14.9998 8.25 14.9998C9.57392 14.9998 10.8784 15.3184 12.0532 15.9287C13.2281 16.539 14.2388 17.4231 15 18.5063"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
